...
export const celestialObjects: CelestialObject[] = [
  ...
  },
  {
    ...
    visual: { color: '#ffe066', emissive: '#ffb703', texture: '/textures/sun.jpg', size: 1.25, position: [0, 0, 0], rotationSpeed: 0.12 },
  },
  {
    id: 'mercury',
    type: 'planet',
    ...
    visual: { color: '#a9a9a9', texture: '/textures/mercury.jpg', size: 0.17, position: [1.45, 0, 0], orbitRadius: 1.45, orbitSpeed: 0.82, orbitTilt: 0.05, rotationSpeed: 0.06, roughness: 1 },
  },
  {
    id: 'venus',
    type: 'planet',
    ...
    visual: { color: '#d9a441', texture: '/textures/venus.jpg', size: 0.26, position: [2.05, 0, 0], orbitRadius: 2.05, orbitSpeed: 0.63, orbitTilt: 0.02, rotationSpeed: 0.025, roughness: 0.65 },
  },
  {
    id: 'earth',
    type: 'planet',
    ...
    visual: {
      ...
      rotationSpeed: 0.12,
      roughness: 0.5,
      moons: [{ name: { zh: '月球', en: 'Moon' }, color: '#b8bcc6', size: 0.075, orbitRadius: 0.52, orbitSpeed: 1.3 }],
    },
  },
  {
    id: 'mars',
    ...
    visual: {
      ...
      roughness: 0.78,
      moons: [
        { name: { zh: '火衛一', en: 'Phobos' }, color: '#7c6b58', size: 0.035, orbitRadius: 0.42, orbitSpeed: 2.1 },
        { name: { zh: '火衛二', en: 'Deimos' }, color: '#6f6254', size: 0.025, orbitRadius: 0.57, orbitSpeed: 1.45 },
      ],
    },
  },
  {
    ...
    visual: {
      ...
      roughness: 0.9,
      moons: [
        { name: { zh: '埃歐', en: 'Io' }, color: '#f4dc74', size: 0.055, orbitRadius: 0.88, orbitSpeed: 1.6 },
        { name: { zh: '歐羅巴', en: 'Europa' }, color: '#cfe8f7', size: 0.05, orbitRadius: 1.08, orbitSpeed: 1.2 },
        { name: { zh: '甘尼米德', en: 'Ganymede' }, color: '#9c9182', size: 0.07, orbitRadius: 1.3, orbitSpeed: 0.9 },
      ],
    },
  },
  {
    ...
    visual: {
      ...
      roughness: 0.88,
      moons: [
        { name: { zh: '泰坦', en: 'Titan' }, color: '#d89b42', size: 0.07, orbitRadius: 1.08, orbitSpeed: 0.78 },
        { name: { zh: '恩克拉多斯', en: 'Enceladus' }, color: '#edf6ff', size: 0.04, orbitRadius: 0.86, orbitSpeed: 1.05 },
      ],
    },
  },
  {
    ...
    visual: { color: '#76e4f7', texture: '/textures/uranus.jpg', size: 0.38, position: [6.8, 0, 0], orbitRadius: 6.8, orbitSpeed: 0.16, orbitTilt: 0.09, rotationSpeed: 0.12, roughness: 0.85 },
  },
  {
    id: 'neptune',
    type: 'planet',
    ...
    visual: { color: '#3d5afe', emissive: '#1f2f98', texture: '/textures/neptune.jpg', size: 0.37, position: [7.85, 0, 0], orbitRadius: 7.85, orbitSpeed: 0.12, orbitTilt: 0.07, rotationSpeed: 0.13, roughness: 0.85 },
  },
  {
    id: 'red-giant',
    type: 'star',
